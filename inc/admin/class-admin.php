...
class Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/loyalty-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'lt_ajax_handle', plugin_dir_url( __FILE__ ) . 'js/loyalty-admin.js', array( 'jquery' ), $this->version, false );				
		wp_localize_script( 'lt_ajax_handle', 'params', $params );		
	...
	public function add_plugin_admin_menu() {
		...
		$page_hook = add_users_page( 
						__( 'ARC loyalty users', $this->plugin_text_domain ), //page title
						__( 'ARC loyalty users', $this->plugin_text_domain ), //menu title
