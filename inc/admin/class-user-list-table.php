...
class User_List_Table extends Libraries\WP_List_Table  {
	...
	public function get_columns() {
		...
		$table_columns = array(
			...
			'user_email'		=>	__( 'User eMail', $this->plugin_text_domain ),			
	...
	public function fetch_table_data() {
		...
		$user_query = "SELECT user_login, display_name,user_email, user_registered, ID
	...
	public function page_view_usermeta( $user_id ) {
		...
		include_once( 'views/partials-wp-list-table-view-usermeta.php' );
	}
	...
	public function page_add_usermeta( $user_id ) {
		...
		$user = get_user_by( 'id', $user_id );		
		include_once( 'views/partials-wp-list-table-add-usermeta.php' );
	}
	...
	public function page_bulk_download( $bulk_user_ids ) {
		...
		include_once( 'views/partials-wp-list-table-bulk-download.php' );
	}    		
